/* ROAR Organic × Vesper Commerce — 1-hour delivery mockup interactions */

// ---------- Product catalog (homepage grid) ----------
const PRODUCTS = [
  {
    "line": "Bottle",
    "name": "Blackberry Lemonade (12 pack)",
    "img": "assets/p0.png",
    "price": "$33.99",
    "status": "",
    "rating": "",
  ...
  {
    "line": "Bottle",
    "name": "Cucumber Watermelon (12 pack)",
    "img": "assets/p1.png",
    "price": "$33.99",
    "status": "",
    "rating": "",
  ...
  {
    "line": "Bottle",
    "name": "Dragon Fruit Punch (12 pack)",
    "img": "assets/p2.png",
    "price": "$33.99",
    "status": "",
    "rating": "",
  ...
  {
    "line": "Bottle",
    "name": "Strawberry Banana (12 pack)",
    "img": "assets/p5.png",
    "price": "$33.99",
    "status": "",
    "rating": "",
  ...
  {
    "line": "Bottle",
    "name": "Strawberry Lemonade (12 pack)",
    "img": "assets/p6.png",
    "price": "$33.99",
    "status": "",
    "rating": "",
  ...
  {
    "line": "Powder",
    "name": "Strawberry Melon Immune Support Powder (12 pac",
    "img": "assets/p7.png",
    "price": "$23.99",
    "status": "",
    "rating": "",
  ...
  {
    "line": "Powder",
    "name": "Tropical Mango Immune Support Powder (12 pack)",
    "img": "assets/p8.jpg",
    "price": "$23.99",
    "status": "",
    "rating": "",
...
// ---------- On-demand catalog (ROAR Organic Now page) ----------
const NOW_PRODUCTS = [
  {
    "line": "Bottle",
    "format": "Single",
...
// ROAR Organic Now address check -> reveal grid
function nowCheck() {
...
function setMode(mode) {
  ...
  if (addBtn && !isOneHr) {
    addBtn.textContent = mode === "subscribe" ? "Subscribe — $30.59" : "Add to cart — $33.99";
  }
}
function pdpCheck() {
...
const CO = { subtotal: 67.98, tax: 6.04, ship: 7.0, shipLabel: "1-Hour delivery" };
...
function placeOrder() {
  ...
  toast(oneHr ? "Order placed ⚡ Routing to nearest store — arriving in ~52 min"
              : "Order placed ✓ Thanks — your ROAR Organic order is confirmed.");
}
document.addEventListener("DOMContentLoaded", updateCheckoutTotals);

// ---------- Slide-out cart drawer + rewards meter ----------
const CART = {"name": "Blackberry Lemonade (12 pack)", "line": "Bottle", "img": "assets/p0.png", "unit": 33.99, "qty": 2, "sub": false};
const TIERS = [
...
function injectMobileMenu() {
  ...
  const active = location.pathname.endsWith("roarorganic-now.html") ? "brand-now" : "";
  const wrap = document.createElement("div");
  wrap.innerHTML = `
    <div class="menu-overlay" id="menuOverlay" onclick="closeMenu()"></div>
    <nav class="mobile-menu" id="mobileMenu" aria-label="Menu">
      <div class="mm-head">
        <span class="wordmark">ROAR Organic</span>
      ...
      <div class="mm-links">
        ...
        <a href="roarorganic-now.html" class="${active === "brand-now" ? "active" : ""}">ROAR Organic Now</a>
      </div>
      <div class="mm-cta"><a href="roarorganic-now.html" class="btn btn-white btn-block">⚡ Check your address</a></div>
      <div class="mm-sub">
